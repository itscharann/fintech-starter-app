...
import { AmountInput } from "./send-funds/AmountInput";
import { SendMethodSelector } from "./send-funds/SendMethodSelector";
import { OrderPreview } from "./send-funds/OrderPreview";
...
export function SendFundsModal({
  ...
  async function handleSend() {
    ...
    try {
      ...
      const amountInSmallestUnit = Math.floor(Number(amount) * 10 ** 6);
      
      const data = encodeFunctionData({
        abi: erc20Abi,
        functionName: "transfer",
        args: [recipientAddress as Address, BigInt(amountInSmallestUnit)],
      });
